Shader "OIT/DFA_Blend"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            TEXTURE2D(_DFA_LayerColorTex);
            SAMPLER(sampler_DFA_LayerColorTex);
            ...
            float4 frag (Varyings i): SV_Target
            {
                ...
                float4 layerCol=SAMPLE_TEXTURE2D(_DFA_LayerColorTex,sampler_DFA_LayerColorTex, i.uv);
